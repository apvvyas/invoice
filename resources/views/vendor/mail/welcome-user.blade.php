...
<head>
    ...
    <title>Welcome - {{$user->name}}</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                                  ...
                                  <table>
                                     <tr>
                                         <td valign="top" style="text-align: center; padding: 60px 0 10px 20px;">
                                             ...
                                             <h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 30px; line-height: 36px; color: #ffffff; font-weight: bold;text-transform: uppercase;">WELCOME {{$user->name}}</h1>
                                         </td>
                                     </tr>
                                     <tr>
                ...
                <tr>
                    <td bgcolor="#ffffff">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <tr>
                                <td style="padding: 0px 40px 10px 40px; font-family: sans-serif; font-size: 12px; line-height: 18px; color: #666666; text-align: center; font-weight:normal;">
                                    <p style="margin: 0;"><a href="{{route('welcome-preview',$user)}}">Preview in Browser</a> | %%Browser%% | %%Forward%% | %%Unsubscribe%%</p>
                                </td>
                            </tr>
                            <tr>
