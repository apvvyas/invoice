            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-12 col-12 d-flex align-items-center">
                    <div class="about-text">
                        ...
                        @auth
                          <a href="{{ url('/admin') }}" class="btn custom-btn custom-btn-bg custom-btn-link">Home</a>
						@else
                          <a href="{{ route('login') }}" class="btn mr-lg-2 custom-btn"><i class='uil uil-file-alt'></i> Login</a>
                          <a href="{{ route('register') }}" class="btn custom-btn custom-btn-bg custom-btn-link">Register</a>
						@endauth
                        </div>
                    </div>
                </div>
